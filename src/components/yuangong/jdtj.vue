    ...
    <div>
        ...
        <el-card class="box-card">
            <el-form ref="form" :model="form" label-width="300px">
                <el-form-item label="水果类销售量（个）">
                    <el-input v-model="form.sg"></el-input>
                </el-form-item>
                <el-form-item label="日用品销售量（个）">
                    <el-input v-model="form.ryp"></el-input>
                </el-form-item>
                <el-form-item label="零食类销售量（个）">
                    <el-input v-model="form.ls"></el-input>
                </el-form-item>
                <el-form-item label="文具类销售量（个）">
                    <el-input v-model="form.wj"></el-input>
                </el-form-item>
                <el-form-item label="销售额（元）">
                    <el-input v-model="form.ze"></el-input>
                </el-form-item>
                <el-form-item label="日期时间">
                    <div class="block">
                        <el-date-picker v-model="form.date" type="datetime" placeholder="选择日期" value-format="yyyy-MM-dd"> </el-date-picker>
                    </div>
                </el-form-item>
    ...
    methods: {
        ...
        onSubmit() {
            this.$axios({
                ...
                // else if (res.data.state == 200 && res.data.data != 1) {
                //     // this.$message({
